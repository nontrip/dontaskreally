...
<div class="yith-wcwl-add-to-wishlist add-to-wishlist-<?php echo esc_attr( $product_id ) ?> <?php echo esc_attr( $container_classes ) ?> wishlist-fragment on-first-load"
     data-fragment-ref="<?php echo esc_attr( $product_id ) ?>"
     data-fragment-options="<?php echo esc_attr( json_encode( $fragment_options ) ) ?>">
	<?php if ( ! $ajax_loading ): ?>
		...
		<?php else: ?>
            ...
            <a
                    ...
                    rel="nofollow"
                    class="disabled_item <?php echo str_replace( array(
						'add_to_wishlist',
