...
<div class="yith-wcwl-wishlistexistsbrowse">
	<span class="feedback">
        ...
        <?php echo ! empty( $already_in_wishslist_text ) ? $already_in_wishslist_text : '' ?>
    </span>
    <a href="<?php echo esc_url( $wishlist_url ) ?>"
       rel="nofollow"
       data-title="<?php echo esc_attr( $browse_wishlist_text ) ?>"
       title="<?php esc_attr_e( 'View Wishlist', 'supro' ) ?>"
       data-rel="tooltip"
    >
		<?php echo ! empty( $icon ) ? $icon : '' ?>
        <span class="indent-text"><?php echo apply_filters( 'yith-wcwl-browse-wishlist-label', $browse_wishlist_text, $product_id, $icon ) ?></span>
    </a>
</div>
