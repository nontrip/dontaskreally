...
$mobile_class = $show_cb ? 'with-checkbox' : '';
?>

<!-- WISHLIST MOBILE -->
<ul class="shop_table cart wishlist_table wishlist_view responsive mobile <?php echo esc_attr( $mobile_class ); ?>"
	...
	if ( $wishlist && $wishlist->has_items() ) :
		foreach ( $wishlist_items as $item ) :
			...
			if ( $product && $product->exists() ) :
				?>
                <li id="yith-wcwl-row-<?php echo esc_attr( $item->get_product_id() ) ?>"
                    ...
                    <div class="item-wrapper">
                        <div class="product-thumbnail">
                            <a href="<?php echo esc_url( get_permalink( apply_filters( 'woocommerce_in_cart_product', $item->get_product_id() ) ) ) ?>">
								<?php echo ! empty( $product->get_image() ) ? $product->get_image() : ''; ?>
                            </a>
                        </div>
                    ...
                    <div class="additional-info-wrapper">
						<?php if ( $show_quantity || $show_stock_status ): ?>
                            <table class="additional-info hidden">
								<?php if ( $show_quantity ) : ?>
                                    <tr>
                                        <td class="label">
											<?php esc_html_e( 'Quantity:', 'supro' ) ?>
							...
							<?php if ( $show_remove_product ): ?>
                                <div class="product-remove">
                                    <a href="<?php echo esc_url( add_query_arg( 'remove_from_wishlist', $item->get_product_id() ) ) ?>"
                                       ...
                                       title="<?php echo apply_filters( 'yith_wcwl_remove_product_wishlist_message_title', esc_html__( 'Remove this product', 'supro' ) ); ?>"><i
        ...
        <p class="wishlist-empty">
			<?php echo apply_filters( 'yith_wcwl_no_product_to_remove_message', esc_html__( 'No products added to the wishlist', 'supro' ) ) ?>
        </p>
	<?php
	endif;
